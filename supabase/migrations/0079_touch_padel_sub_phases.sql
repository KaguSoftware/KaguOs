...
begin
  if not exists (
    ...
    raise exception
      '0079 requires 0078: project_milestones.parent_id does not exist. Apply 0078_custom_payment_schedules.sql (its sub-phases half) first, then re-run this file.';
  end if;
end $$;
