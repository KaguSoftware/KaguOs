        ...
        <div className="border-b border-line last:border-b-0">
            ...
            <div className="flex items-center gap-3 px-4 py-2.5">
                <span
                    ...
                    style={{
                        backgroundColor: memberColorCss(user.id, user.color),
                    }}
                />
                <div className="min-w-0 flex-1">
                    ...
                    <p className="truncate text-[calc(13px*var(--text-scale,1))] text-faint">
                        {user.email}
                    </p>
                        ...
                        <div>
                            ...
                            {projects.length === 0 ? (
                                <p className="text-[calc(13px*var(--text-scale,1))] text-faint">
                                    No projects exist yet. Create one in Work
                                    first.
                                </p>
                            ) : (
                                <div className="grid gap-1.5 sm:grid-cols-2">
                                    {projects.map((project) => (
                                        <Checkbox
                                            ...
                                            checked={user.projectIds.includes(
                                                project.id
                                            )}
                                            onChange={() =>
                            ...
                            <p className="mt-2 flex items-start gap-1.5 text-[calc(12px*var(--text-scale,1))] text-faint">
                                <Building2
                                    ...
                                    aria-hidden
                                />
                                They&rsquo;ll see the project&rsquo;s name and
                                its input pack — never the repo, the notes, the
                                board, or anyone else&rsquo;s project.
                            </p>
                        </div>
                    ) : (
                        <div>
                  ...
                  is on — there is no tier for access you don't have. */}
                            ...
                            <div className="mt-2.5 border-t border-line pt-2.5">
                                <Checkbox
                                    ...
                                    onChange={() =>
                                        apply(user.access, !user.is_admin)
                                    }
