...
const ALL: Command[] = [
  ...
  { id: "mkt-new-creative", label: "New video", href: "/marketing/new-creative", icon: Plus, write: true, section: "marketing", keywords: "create add creative shoot" },
  { id: "mkt-new-client", label: "New client", href: "/marketing/clients/new", icon: Plus, write: true, section: "marketing", keywords: "create add account" },
