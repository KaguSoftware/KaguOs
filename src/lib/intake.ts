...
const GENERAL_SECTIONS: IntakeSection[] = [
  {
    ...
    blurbAr:
      "الإجابات القليلة التي لا يبدأ البناء بدونها. معظمها نقرة واحدة، ولا شيء فيها نهائي — أخبرونا إن تغيّر شيء.",
    cards: [
      {
        key: "filler",
        ...
        hintAr: "لنعرف بمن نتواصل عندما تحتاج إجابة إلى مراجعة.",
        due: "week1",
        kind: "fields",
        fields: [
          { key: "name", label: "Full name", labelAr: "الاسم الكامل", kind: "text", required: true, span: 4, placeholder: "Your name", placeholderAr: "اسمكم" },
          { key: "role", label: "Role at the business", labelAr: "الصفة في العمل", kind: "text", span: 4, placeholder: "Owner / Manager", placeholderAr: "مالك / مدير" },
          { key: "contact", label: "Phone or email", labelAr: "الهاتف أو الإيميل", kind: "text", required: true, span: 4, placeholder: "The number you actually answer", placeholderAr: "الرقم الذي تردّون عليه فعلاً" },
        ],
      },
      {
        key: "currency",
        ...
        hintAr: "النظام يعمل بعملة واحدة وبأرقام صحيحة. التعامل بعملتين جنباً إلى جنب عمل منفصل — أخبرونا الآن إن كنتم تحتاجونه.",
        due: "week1",
        kind: "fields",
        flag: { key: "mode", values: ["discuss"], note: "flagged to discuss on the next call", noteAr: "مؤشَّر لمناقشته في المكالمة القادمة" },
        fields: [
          {
            key: "mode",
            ...
            required: true,
            options: [
              { value: "single", label: "One currency — confirmed", labelAr: "عملة واحدة — مؤكد" },
              { value: "discuss", label: "We need to talk about this", labelAr: "نحتاج لمناقشة هذا" },
            ],
          },
          {
            key: "code",
      ...
      },
      {
        ...
        hintAr: "الافتراضي ٠٪ على كل شيء إلى أن يقرر محاسبكم غير ذلك. وإن كانت أي مجموعة أصناف تحمل ضريبة، نحتاج النسبة لكل مجموعة كتابياً منه.",
        due: "week1",
        kind: "fields",
        flag: { key: "mode", values: ["pending"], note: "waiting on the accountant", noteAr: "بانتظار المحاسب" },
        fields: [
          {
            key: "mode",
            label: "Tax position",
            labelAr: "الوضع الضريبي",
            kind: "choice",
            required: true,
            options: [
              { value: "zero", label: "0% across the board", labelAr: "صفر على الكل" },
              { value: "rates", label: "Some groups carry tax", labelAr: "توجد ضريبة" },
              { value: "pending", label: "Waiting on our accountant", labelAr: "بانتظار المحاسب" },
            ],
          },
          {
            key: "rates",
            ...
            placeholderAr: "مثلاً: طعام ٠٪ · مشروبات ٥٪",
      ...
      },
      {
        ...
        hintAr: "كل نص يُكتب مرة لكل لغة. إضافة لغة لاحقاً رخيصة، أما إضافتها بعد كتابة المحتوى فليست كذلك.",
        due: "week1",
        kind: "fields",
        fields: [
          { key: "primary", label: "Languages the build must ship in", labelAr: "اللغات المطلوبة عند الإطلاق", kind: "text", required: true, span: 6, placeholder: "English + Arabic", placeholderAr: "الإنجليزية + العربية" },
          { key: "default", label: "Which one opens by default", labelAr: "اللغة التي تفتح افتراضياً", kind: "text", span: 6, placeholder: "Arabic", placeholderAr: "العربية" },
        ],
      },
      {
        key: "domain",
        ...
        hintAr: "مسجل باسم شركتكم مع مشاركة صلاحية DNS مع كاغو — بدونه لا يمكن إطلاق الموقع على عنوانكم الخاص.",
        due: "week1",
        kind: "fields",
        flag: { key: "status", values: ["help"], note: "asked Kagu to handle the registration", noteAr: "طلب من كاغو تولّي التسجيل" },
        fields: [
          { key: "name", label: "The exact domain", labelAr: "النطاق بالضبط", kind: "text", required: true, span: 6, placeholder: "yourbusiness.com", placeholderAr: "yourbusiness.com" },
          {
            key: "status",
            ...
            options: [
              ...
              { value: "registering", label: "Registering this week", labelAr: "هذا الأسبوع" },
              { value: "help", label: "We need Kagu's help", labelAr: "نحتاج مساعدة كاغو" },
            ],
          },
        ],
      },
      {
        ...
        titleAr: "النسخ الاحتياطي والاسترجاع",
        ...
        hintAr: "الاسترجاع لأي لحظة يعيد بياناتكم إلى أي دقيقة خلال آخر سبعة أيام، وهو إضافة مدفوعة على فاتورة استضافتكم. أما النسخ اليومي فمشمول ويسترجع لليوم السابق في أسوأ حال.",
        due: "week1",
        kind: "fields",
        fields: [
          {
            ...
            required: true,
            options: [
              { value: "pitr", label: "Point-in-time recovery (paid add-on)", labelAr: "الاسترجاع لأي لحظة (إضافة مدفوعة)" },
              { value: "daily", label: "Daily backups only (included)", labelAr: "النسخ اليومي فقط (مشمول)" },
            ],
          },
        ],
      },
      {
        ...
        hintAr: "شخص واحد بالاسم، متاح مرة في الأسبوع، ويملك صلاحية الموافقة. بدونه لا يُعتمد شيء ويتأخر الجدول بينما ينتظر الجميع من يؤكد أن كل شيء على ما يرام.",
        due: "week1",
        kind: "fields",
        fields: [
          { key: "name", label: "Name", labelAr: "الاسم", kind: "text", required: true, span: 4 },
          { key: "contact", label: "Phone or email", labelAr: "الهاتف أو الإيميل", kind: "text", required: true, span: 4 },
          { key: "slot", label: "A weekly slot that suits them", labelAr: "الموعد الأسبوعي المناسب", kind: "text", span: 4, placeholder: "Fridays, early evening", placeholderAr: "الجمعة، أول المساء" },
        ],
      },
    ],
  },
  {
    ...
    titleAr: "الأوقات والسياسات",
    due: "week1",
    blurb: "When you're open, and what happens when a customer changes their mind.",
    blurbAr: "أوقات عملكم، وما الذي يحدث عندما يغيّر الزبون رأيه.",
    cards: [
      {
        key: "hours",
        title: "Opening hours",
        ...
        hintAr: "اجمعوا الأيام التي تتشارك نفس الأوقات — سطر واحد للاثنين–الخميس أفضل من أربعة أسطر متطابقة. بنظام ٢٤ ساعة، و24:00 تعني الإغلاق منتصف الليل.",
        due: "week1",
        kind: "table",
        addLabel: "Add a line",
        ...
        emptyHintAr: "لا شيء بعد — أضيفوا أول سطر في الأسفل.",
        columns: [
          { key: "days", label: "Days", labelAr: "الأيام", kind: "text", required: true, span: 4, placeholder: "Mon–Thu", placeholderAr: "الاثنين–الخميس" },
          { key: "opens", label: "Opens", labelAr: "يفتح", kind: "text", required: true, span: 2, placeholder: "09:00", placeholderAr: "09:00" },
          { key: "closes", label: "Closes", labelAr: "يغلق", kind: "text", required: true, span: 2, placeholder: "24:00", placeholderAr: "24:00" },
          { key: "note", label: "Note", labelAr: "ملاحظة", kind: "text", span: 4 },
        ],
      },
      {
        key: "policies",
        title: "Closures and cancellations",
        titleAr: "الإغلاقات والإلغاءات",
        due: "week1",
        kind: "fields",
        fields: [
          { key: "holidays", label: "Days you know you'll be closed", labelAr: "الأيام التي تعرفون أنكم ستغلقون فيها", kind: "text", span: 6, placeholder: "Public holidays…", placeholderAr: "العطل الرسمية…" },
          { key: "cancelHours", label: "Free cancellation up to (hours before)", labelAr: "مهلة الإلغاء المجاني (ساعات قبل الموعد)", kind: "number", required: true, span: 3, placeholder: "6", placeholderAr: "6" },
          { key: "cancelNote", label: "And after that", labelAr: "وبعد ذلك", kind: "text", span: 3, placeholder: "No cancellation", placeholderAr: "لا يُسمح بالإلغاء" },
        ],
      },
    ],
  },
  {
    ...
    blurbAr:
      "قائمة الأسعار كاملة. هذا أطول عمل في الحزمة، ولا يبدأ أي شيء آخر قبل أن ينتهي — كل شاشة في النظام ما هي إلا عرض لهذه القائمة.",
    cards: [
      {
        key: "items",
        ...
        hintAr: "سطر واحد لكل صنف بسعر واحد. ثلاثة أحجام تعني ثلاثة أسطر.",
        due: "week1",
        kind: "table",
        addLabel: "Add a product",
        addLabelAr: "أضف منتجاً",
        minRows: 1,
        emptyHint: "Nothing yet. Start with the ten things you sell most.",
        emptyHintAr: "لا شيء بعد. ابدأوا بالعشرة الأكثر مبيعاً عندكم.",
        columns: [
          { key: "category", label: "Category", labelAr: "القسم", kind: "text", span: 3, placeholder: "Hot drinks", placeholderAr: "مشروبات ساخنة" },
          { key: "name", label: "Name", labelAr: "الاسم", kind: "text", required: true, span: 3, placeholder: "Cappuccino", placeholderAr: "كابتشينو" },
          { key: "variant", label: "Size or variant", labelAr: "الحجم أو النوع", kind: "text", span: 2, placeholder: "Regular", placeholderAr: "عادي" },
          { key: "price", label: "Price", labelAr: "السعر", kind: "number", required: true, span: 2, placeholder: "7000", placeholderAr: "7000" },
          { key: "description", label: "Description", labelAr: "الوصف", kind: "text", span: 6 },
          { key: "notes", label: "Notes", labelAr: "ملاحظات", kind: "text", span: 6 },
        ],
      },
      {
        key: "bookables",
        title: "Anything booked by time",
        titleAr: "كل ما يُحجز بالوقت",
        hint: "Rooms, courts, tables, appointment slots. Skip it if nothing you sell works that way.",
        hintAr: "غرف، ملاعب، طاولات، مواعيد. تجاوزوها إن لم يكن عندكم شيء يُباع بهذه الطريقة.",
        due: "week1",
        kind: "table",
        addLabel: "Add a bookable",
        addLabelAr: "أضف عنصراً للحجز",
        emptyHint: "Nothing booked by time — skip this one.",
        emptyHintAr: "لا شيء يُحجز بالوقت — تجاوزوا هذه.",
        columns: [
          { key: "name", label: "Name", labelAr: "الاسم", kind: "text", required: true, span: 4 },
          { key: "type", label: "Type", labelAr: "النوع", kind: "text", span: 3 },
          { key: "durations", label: "Slot lengths (minutes)", labelAr: "مدد الحجز بالدقائق", kind: "text", required: true, span: 3, placeholder: "60; 90; 120", placeholderAr: "60; 90; 120" },
          { key: "price", label: "Price per slot", labelAr: "سعر الحجز الواحد", kind: "number", span: 2 },
        ],
      },
    ],
  },
  {
    ...
    blurbAr: "تُنشأ الحسابات وبيانات الدخول التدريبية من هذه القائمة.",
    cards: [
      {
        key: "staff",
        title: "Everyone who will use the system",
        titleAr: "كل من سيستخدم النظام",
        due: "week3",
        kind: "table",
        addLabel: "Add a person",
        addLabelAr: "أضف شخصاً",
        minRows: 1,
        emptyHint: "Nothing yet — start with whoever works the till.",
        emptyHintAr: "لا شيء بعد — ابدأوا بمن يعمل على الكاشير.",
        columns: [
          { key: "name", label: "Name", labelAr: "الاسم", kind: "text", required: true, span: 5 },
          { key: "role", label: "What they do", labelAr: "الدور", kind: "text", required: true, span: 4, placeholder: "Till · Kitchen · Manager", placeholderAr: "كاشير · مطبخ · مدير" },
          { key: "note", label: "Note", labelAr: "ملاحظة", kind: "text", span: 3 },
        ],
      },
    ],
  },
  {
    ...
    blurbAr:
      "لا يمكن إرفاق الملفات هنا — أرسلوها بالطريقة التي تُرسلون بها الأشياء عادةً، وأخبرونا أين نجدها.",
    cards: [
      {
        key: "assets",
        title: "What we need, and where it is",
        titleAr: "ما نحتاجه، وأين نجده",
        due: "week1",
        kind: "fields",
        fields: [
          { key: "logo", label: "Logo files", labelAr: "ملفات الشعار", kind: "text", required: true, span: 6, placeholder: "A link, or “sending it on WhatsApp”", placeholderAr: "رابط، أو «سنرسلها على واتساب»" },
          { key: "colors", label: "Brand colours", labelAr: "ألوان العلامة", kind: "text", span: 6 },
          { key: "photos", label: "Photography", labelAr: "الصور", kind: "text", span: 6, placeholder: "A link, or “none yet”", placeholderAr: "رابط، أو «لا توجد بعد»" },
          { key: "fonts", label: "Font files", labelAr: "ملفات الخطوط", kind: "text", span: 6 },
          { key: "copyOwner", label: "Who writes the words", labelAr: "من يكتب النصوص", kind: "text", required: true, span: 6, placeholder: "A name — or “Kagu drafts, we review”", placeholderAr: "اسم الشخص — أو «كاغو تكتب ونحن نراجع»" },
          { key: "copyBy", label: "Words ready by", labelAr: "موعد جاهزية النصوص", kind: "date", span: 6 },
        ],
      },
    ],
  },
  {
    ...
    blurbAr: "السؤال الذي لا يخطر على بال أي نموذج.",
    cards: [
      {
        key: "notes",
        title: "Anything we should know?",
        titleAr: "هل من شيء يجب أن نعرفه؟",
        due: "week1",
        kind: "fields",
        fields: [
          { key: "body", label: "In your own words", labelAr: "بكلماتكم", kind: "long", span: 12, placeholder: "Questions, concerns, special cases…", placeholderAr: "أسئلة، ملاحظات، حالات خاصة…" },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        kind: "fields",
        fields: [
          { key: "name", label: "Full name", labelAr: "الاسم الكامل", kind: "text", required: true, span: 4, placeholder: "Mustafa …", placeholderAr: "مصطفى …" },
          { key: "role", label: "Role at Touch", labelAr: "الصفة", kind: "text", span: 4, placeholder: "Owner / Manager", placeholderAr: "مالك / مدير" },
          { key: "contact", label: "WhatsApp / email", labelAr: "واتساب أو إيميل", kind: "text", required: true, span: 4, placeholder: "+964 …", placeholderAr: "+964 …" },
        ],
      },
      {
        key: "currency",
        ...
        due: "week1",
        kind: "fields",
        flag: { key: "mode", values: ["discuss"], note: "flagged for the call", noteAr: "مؤشَّر لمناقشته في المكالمة" },
        fields: [
          {
            key: "mode",
            label: "Currency",
      ...
      },
      {
        ...
        due: "week1",
        kind: "fields",
        flag: { key: "mode", values: ["pending"], note: "waiting on accountant", noteAr: "بانتظار المحاسب" },
        fields: [
          {
            key: "mode",
            label: "Tax",
          ...
          },
          {
            ...
            placeholderAr: "مثلاً: طعام ٠٪ · مشروبات ٥٪ — كما حددها المحاسب",
            showWhen: { key: "mode", values: ["rates"] },
          },
        ],
      },
      {
        ...
        due: "week1",
        kind: "fields",
        flag: { key: "needed", values: ["yes"], note: "change request to quote", noteAr: "طلب تغيير يحتاج تسعيراً" },
        fields: [
          {
            key: "needed",
            label: "Kurdish",
      ...
      },
      {
        ...
        due: "week1",
        kind: "fields",
        flag: { key: "status", values: ["help"], note: "needs Kagu's help", noteAr: "يحتاج مساعدة كاغو" },
        fields: [
          { key: "name", label: "Exact domain", labelAr: "النطاق بالضبط", kind: "text", required: true, span: 6, placeholder: "touchpadel.com", placeholderAr: "touchpadel.com" },
          {
            key: "status",
            label: "Status",
            labelAr: "الحالة",
      ...
      },
      {
        ...
        due: "week1",
        kind: "fields",
        flag: { key: "status", values: ["question"], note: "the client has a question", noteAr: "لدى العميل سؤال" },
        fields: [
          {
            key: "status",
            label: "Down payment",
      ...
      },
      {
        ...
        kind: "fields",
        fields: [
          { key: "name", label: "Name", labelAr: "الاسم", kind: "text", required: true, span: 4, placeholder: "Mustafa …", placeholderAr: "مصطفى …" },
          { key: "contact", label: "WhatsApp / email", labelAr: "واتساب / إيميل", kind: "text", required: true, span: 4, placeholder: "+964 …", placeholderAr: "+964 …" },
          { key: "slot", label: "Weekly slot that suits them", labelAr: "الموعد الأسبوعي المناسب", kind: "text", span: 4, placeholder: "e.g. Fridays 6pm", placeholderAr: "مثلاً: الجمعة ٦ مساءً" },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        due: "week1",
        kind: "fields",
        flag: { key: "status", values: ["help"], note: "needs a walkthrough", noteAr: "يحتاج شرحاً خطوة بخطوة" },
        fields: [
          {
            key: "status",
            label: "Account",
          ...
          { key: "email", label: "Billing email on the account", labelAr: "إيميل الفوترة", kind: "text", span: 6, placeholder: "billing@touchpadel.com", placeholderAr: "billing@touchpadel.com" },
          {
            key: "region",
      ...
      },
      {
        ...
        due: "week2",
        kind: "fields",
        flag: { key: "status", values: ["help"], note: "needs help choosing", noteAr: "يحتاج مساعدة في الاختيار" },
        fields: [
          { key: "model", label: "Model you are buying", labelAr: "الموديل", kind: "text", span: 5, placeholder: "Epson TM-T20III (Ethernet)", placeholderAr: "Epson TM-T20III (Ethernet)" },
          {
            key: "status",
            label: "Status",
            labelAr: "الحالة",
      ...
      },
      {
        ...
        due: "week2",
        kind: "fields",
        flag: { key: "staticIp", values: ["who"], note: "router manager unknown — tell Kagu", noteAr: "مدير الراوتر غير معروف — أبلغوا كاغو" },
        fields: [
          {
            key: "ups",
            label: "UPS",
          ...
          { key: "routerOwner", label: "Who manages the venue router?", labelAr: "من يدير الراوتر؟", kind: "text", span: 6, placeholder: "Name / company + phone", placeholderAr: "الاسم / الشركة + رقم الهاتف" },
    ...
    cards: [
      {
        ...
        columns: [
          { key: "en", label: "Court name (EN)", labelAr: "اسم الملعب EN", kind: "text", required: true, span: 4, placeholder: "Court 1", placeholderAr: "Court 1" },
          ...
          { key: "dur", label: "Durations (min)", labelAr: "المدد", kind: "text", required: true, span: 2, placeholder: "60;90;120", placeholderAr: "60;90;120" },
        ],
      },
      {
        key: "hours",
      ...
      },
      {
        ...
        kind: "fields",
        fields: [
          { key: "closedDays", label: "Known holiday closures", labelAr: "إغلاقات الأعياد المعروفة", kind: "text", span: 6, placeholder: "e.g. Eid al-Fitr day 1, Eid al-Adha day 1", placeholderAr: "مثلاً: أول أيام عيد الفطر، أول أيام عيد الأضحى" },
          { key: "cancelHours", label: "Cancellation — hours before start", labelAr: "مهلة الإلغاء (ساعات)", kind: "number", required: true, span: 3, placeholder: "6", placeholderAr: "6" },
          { key: "cancelNote", label: "Cancellation note", labelAr: "ملاحظة", kind: "text", span: 3, placeholder: "After that, no cancellation", placeholderAr: "بعدها لا يُسمح بالإلغاء" },
        ],
      },
      {
        key: "rates",
        ...
        columns: [
          { key: "court", label: "Court — name as above, or “All courts”", labelAr: "الملعب", kind: "text", required: true, span: 3, placeholder: "All courts", placeholderAr: "كل الملاعب" },
          {
            key: "days",
            label: "Days",
            labelAr: "الأيام",
          ...
          { key: "ws", label: "From (24h)", labelAr: "من", kind: "text", required: true, span: 2, placeholder: "17:00", placeholderAr: "17:00" },
          { key: "we", label: "To (24h)", labelAr: "إلى", kind: "text", required: true, span: 2, placeholder: "23:00", placeholderAr: "23:00" },
          { key: "dur", label: "Duration (min)", labelAr: "المدة", kind: "number", required: true, span: 2, placeholder: "90", placeholderAr: "90" },
          { key: "price", label: "Price (whole IQD)", labelAr: "السعر بالدينار", kind: "number", required: true, span: 3, placeholder: "45000", placeholderAr: "45000" },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        columns: [
          { key: "cat_en", label: "Category (EN)", labelAr: "القسم EN", kind: "text", required: true, span: 3, placeholder: "Hot Drinks", placeholderAr: "Hot Drinks" },
          { key: "cat_ar", label: "Category (AR)", labelAr: "القسم AR", kind: "text", required: true, span: 3, rtl: true, placeholder: "مشروبات ساخنة" },
          { key: "item_en", label: "Item (EN)", labelAr: "المنتج EN", kind: "text", required: true, span: 3, placeholder: "Cappuccino", placeholderAr: "Cappuccino" },
          { key: "item_ar", label: "Item (AR)", labelAr: "المنتج AR", kind: "text", required: true, span: 3, rtl: true, placeholder: "كابتشينو" },
          { key: "desc_en", label: "Description (EN, optional)", labelAr: "الوصف EN", kind: "text", span: 6, placeholder: "Double shot with steamed milk", placeholderAr: "Double shot with steamed milk" },
          { key: "desc_ar", label: "Description (AR)", labelAr: "الوصف AR", kind: "text", span: 6, rtl: true, placeholder: "جرعتان مع حليب مبخر" },
          { key: "size_en", label: "Size (EN)", labelAr: "الحجم EN", kind: "text", required: true, span: 2, placeholder: "Regular", placeholderAr: "Regular" },
          { key: "size_ar", label: "Size (AR)", labelAr: "الحجم AR", kind: "text", required: true, span: 2, rtl: true, placeholder: "عادي" },
          { key: "price", label: "Price (IQD)", labelAr: "السعر", kind: "number", required: true, span: 2, placeholder: "7000", placeholderAr: "7000" },
          { key: "mg_en", label: "Modifier group (EN)", labelAr: "مجموعة الخيارات EN", kind: "text", span: 3, placeholder: "Milk", placeholderAr: "Milk" },
          { key: "mg_ar", label: "Modifier group (AR)", labelAr: "مجموعة الخيارات AR", kind: "text", span: 3, rtl: true, placeholder: "الحليب" },
          { key: "mo_en", label: "Modifier option (EN)", labelAr: "الخيار EN", kind: "text", span: 3, placeholder: "Oat milk", placeholderAr: "Oat milk" },
          { key: "mo_ar", label: "Modifier option (AR)", labelAr: "الخيار AR", kind: "text", span: 3, rtl: true, placeholder: "حليب الشوفان" },
          { key: "mdelta", label: "+ price (IQD, 0 = free)", labelAr: "السعر الإضافي", kind: "number", span: 2, placeholder: "1000", placeholderAr: "1000" },
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        columns: [
          { key: "item", label: "Item (EN) — as in Menu", labelAr: "المنتج كما في القائمة", kind: "text", required: true, span: 3, placeholder: "Cappuccino", placeholderAr: "Cappuccino" },
          { key: "item_ar", label: "Item (AR)", labelAr: "المنتج AR", kind: "text", span: 2, rtl: true, placeholder: "كابتشينو" },
          { key: "size", label: "Size — as in Menu", labelAr: "الحجم", kind: "text", required: true, span: 2, placeholder: "Large", placeholderAr: "كبير" },
          { key: "ing", label: "Ingredient or sub-recipe", labelAr: "المكون أو الوصفة الفرعية", kind: "text", required: true, span: 3, placeholder: "Espresso beans", placeholderAr: "حبوب إسبريسو" },
          { key: "qty", label: "Qty", labelAr: "الكمية", kind: "number", required: true, span: 1, placeholder: "18", placeholderAr: "18" },
      ...
      },
      {
        ...
        columns: [
          { key: "en", label: "Sub-recipe name (EN)", labelAr: "الاسم EN", kind: "text", required: true, span: 4, placeholder: "Garlic sauce", placeholderAr: "Garlic sauce" },
          { key: "ar", label: "Sub-recipe name (AR)", labelAr: "الاسم AR", kind: "text", required: true, span: 4, rtl: true, placeholder: "صلصة الثوم" },
          { key: "yq", label: "Batch yield — qty", labelAr: "إنتاج الدفعة", kind: "number", required: true, span: 2, placeholder: "800", placeholderAr: "800" },
      ...
      },
      {
        ...
        columns: [
          { key: "sub", label: "Sub-recipe (EN) — as above", labelAr: "الوصفة الفرعية", kind: "text", required: true, span: 4, placeholder: "Garlic sauce", placeholderAr: "Garlic sauce" },
          { key: "ing", label: "Ingredient", labelAr: "المكون", kind: "text", required: true, span: 4, placeholder: "Garlic", placeholderAr: "ثوم" },
          { key: "qty", label: "Qty", labelAr: "الكمية", kind: "number", required: true, span: 2, placeholder: "100", placeholderAr: "100" },
      ...
      },
      {
        ...
        columns: [
          { key: "en", label: "Ingredient (EN)", labelAr: "المكون EN", kind: "text", required: true, span: 4, placeholder: "Espresso beans", placeholderAr: "Espresso beans" },
          { key: "ar", label: "Ingredient (AR)", labelAr: "المكون AR", kind: "text", required: true, span: 4, rtl: true, placeholder: "حبوب إسبريسو" },
          { key: "pack", label: "Pack size (with unit)", labelAr: "حجم العبوة", kind: "text", required: true, span: 4, placeholder: "1000 g", placeholderAr: "1000 غرام" },
          { key: "cost", label: "Pack cost (whole IQD)", labelAr: "تكلفة العبوة", kind: "number", required: true, span: 3, placeholder: "25000", placeholderAr: "25000" },
          { key: "supplier", label: "Supplier", labelAr: "المورد", kind: "text", required: true, span: 6, placeholder: "Al-Rasheed Foods", placeholderAr: "الرشيد للمواد الغذائية" },
          { key: "shelf", label: "Shelf life (days)", labelAr: "الصلاحية بالأيام", kind: "number", required: true, span: 3, placeholder: "90", placeholderAr: "90" },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        kind: "fields",
        fields: [
          { key: "count", label: "Number of tables", labelAr: "عدد الطاولات", kind: "number", required: true, span: 3, placeholder: "12", placeholderAr: "12" },
          { key: "scheme", label: "Numbering scheme", labelAr: "طريقة الترقيم", kind: "text", required: true, span: 5, placeholder: "1–12, or A1–A6 inside + B1–B6 terrace", placeholderAr: "1–12، أو A1–A6 في الداخل + B1–B6 في التراس" },
          { key: "layout", label: "Floor layout — link, or “via WhatsApp”", labelAr: "رابط المخطط أو «واتساب»", kind: "text", span: 4, placeholder: "Drive link / via WhatsApp", placeholderAr: "رابط درايف / عبر واتساب" },
    ...
    cards: [
      {
        ...
        kind: "fields",
        fields: [
          { key: "logo", label: "Logo files — link, or “via WhatsApp”", labelAr: "ملفات الشعار", kind: "text", required: true, span: 6, placeholder: "Drive link / via WhatsApp", placeholderAr: "رابط درايف / عبر واتساب" },
          { key: "colors", label: "Brand colours", labelAr: "ألوان العلامة", kind: "text", span: 6, placeholder: "#0A84FF, black … or “in the logo file”", placeholderAr: "#0A84FF، أسود … أو «موجودة في ملف الشعار»" },
          { key: "photos", label: "Photography — link, “via WhatsApp”, or “none yet”", labelAr: "الصور", kind: "text", span: 6, placeholder: "Drive link / none yet", placeholderAr: "رابط درايف / لا توجد صور بعد" },
          { key: "fontsLink", label: "Font licence files — link, or “via WhatsApp”", labelAr: "ملفات الخطوط", kind: "text", span: 6, placeholder: "Drive link / via WhatsApp", placeholderAr: "رابط درايف / عبر واتساب" },
          { key: "copyOwner", label: "English + Arabic website copy — who provides it", labelAr: "من يقدم النصوص بالإنجليزية والعربية", kind: "text", required: true, span: 6, placeholder: "Name — or “Kagu drafts, we review”", placeholderAr: "اسم الشخص — أو «كاغو تكتب ونحن نراجع»" },
